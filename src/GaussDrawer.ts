...
class GaussDrawer {
   ...
   */
    constructor(points: Vector2[], weights: number[], width: number, height: number, sigma: number = 0.3, interval: number = 0, colormap: string[] | null = null, opacity: number = 1.0, normalized: boolean = false) {
        this.points = points;
    ...
    setFromArray(arr_points: number[][], arr_weights: number[]): void {
        this.points = [];
